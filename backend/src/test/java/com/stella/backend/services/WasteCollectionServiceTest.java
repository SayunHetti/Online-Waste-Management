...
class WasteCollectionServiceTest {
    ...
    void setUp() {
        ...
        wasteCollectionRequestDTO.setImageUrl("http://example.com/image.jpg");
    ...
    void testSaveWasteCollectionSuccess() {
        ...
        savedWasteCollection.setRoute("Main Street");
        ...
        WasteCollectionResponseDTO responseDTO = wasteCollectionService.saveWasteCollection(requestId, wasteCollectionRequestDTO, "Main Street");
    ...
    void testSaveWasteCollectionRequestNotFound() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> {
            wasteCollectionService.saveWasteCollection(requestId, wasteCollectionRequestDTO, "Main Street");
        });
    ...
    void testGetWasteCollectionByRequestIdSuccess() {
        ...
        wasteCollection.setImageUrl("http://example.com/image.jpg");
        wasteCollection.setCollectedDateTime(LocalDateTime.now());
        wasteCollection.setRoute("Main Street");
        ...
        assertNotNull(responseDTO);
        assertEquals(1L, responseDTO.getId());
        assertEquals("http://example.com/image.jpg", responseDTO.getImageUrl());
