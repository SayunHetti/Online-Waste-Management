...
const FormSubmissionPage = () => {
    ...
    const [fileBase64, setFileBase64] = useState('');  // State to store Base64 string
    ...
    const { getRootProps, getInputProps } = useDropzone({
        ...
        onDrop: acceptedFiles => {
            ...
            reader.onloadend = () => {
                setFileBase64(reader.result); // Set the Base64 string here
            };
        }
    });
    ...
    const handleSubmit = async (e) => {
        ...
        const requestPayload = {
            imageUrl: fileBase64,  // Use the Base64 string here
